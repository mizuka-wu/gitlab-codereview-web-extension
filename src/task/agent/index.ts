...
import { DEFAULT_OLLAMA_END_POINT, DEFAUTL_PROMPT, DEFAULT_OPENAI_CONFIG, DEFAULT_CLAUDE_CONFIG, DEFAULT_OPENAPI_CONFIG } from '../../constants';
  ...
  switch (current) {
    ...
    case 'openapi': {
      ...
      const apiConfig = {
        ...
        requestMethod: config.requestMethod || DEFAULT_OPENAPI_CONFIG.requestMethod,
        ...
        authHeaderName: config.authHeaderName || DEFAULT_OPENAPI_CONFIG.authHeaderName,
        authQueryName: config.authQueryName || DEFAULT_OPENAPI_CONFIG.authQueryName
      };
